...
<html>
	<head>
		...
		*{margin:0px; padding:0px;}
		...
		#qq .But input.submit{width:80px;height:30px; background:#ff8140;display:block; float:right;/*右浮动*/								
...
<script type="text/javascript" src="js/jquery-1.10.2.min.js"></script>
	<script type="text/javascript">
		var  postid=myform.userid.value;
		var  postname=myform.username.value;
	...
	$("input.submit").click(function(){
		...
		if(txt==""){
			...
			$.ajax({
				...
				async:true,
				datetype:"json",
				data:{"content":txt,"postid":postid,"postname":postname},
	...
	$(".msgCon").prepend("<div class='msgBox'><dl><dt><img src='images/tx.jpg' width='50' height='50'/></dt>"+postname+"</dl><div class='msgTxt'>"+txt+"</div></div>");
	});
